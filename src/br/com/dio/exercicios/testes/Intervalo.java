...
public class Intervalo {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (valor >= 0 && valor <= 25) {
            ...
            System.out.println("Intervalo (25,50]"); //intervalo aberto
        } else if (valor > 50 && valor <= 75) {
            System.out.println("Intervalo (50,75]");  //intervalo aberto
        } else if (valor > 75 && valor <= 100) {
            System.out.println("Intervalo (75,100]"); //intervalo aberto
        } else {
